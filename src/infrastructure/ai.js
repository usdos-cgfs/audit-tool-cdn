...
const sentenceSimilarityTaskDef = new TaskDef(
  "Searching for similar text",
  true
);
const loadModelTaskDef = new TaskDef("Loading model", true);
const embeddingSentencesTaskDef = new TaskDef("Consulting the haruspex", true);
const cosineSearchTaskDef = new TaskDef("Comparing vectors", true);
