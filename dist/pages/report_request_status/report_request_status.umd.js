  ...
  `;
	...
	Audit.IAReport.NewReportPage = function () {
	  ...
	  function ViewModel() {
	    ...
	    self.arrFilteredRequestsCount = knockoutLatestExports.observable(0);

	    /* request tab */
	    self.ddOptionsRequestAuditStatus = knockoutLatestExports.observableArray();
	    self.ddOptionsRequestNum = knockoutLatestExports.observableArray();
	    self.ddOptionsRequestStatus = knockoutLatestExports.observableArray();

	    self.filterRequestAuditStatus = knockoutLatestExports.observable();
	    self.filterRequestNum = knockoutLatestExports.observable();
	    self.filterRequestStatus = knockoutLatestExports.observable();
	    self.doSort = knockoutLatestExports.observable(false);

	    self.selectedFiltersTab = knockoutLatestExports.computed(function () {
	    ...
	    self.GetDDVals = function (oObjectProperties) {
	      ...
	      var types = knockoutLatestExports.utils.arrayMap(arr, function (item) {
	      ...
	      if (oObjectProperties.isArr) {
	        ...
	        ddArr = knockoutLatestExports.utils.arrayGetDistinctValues(tempArr).sort();
	      } else ddArr = knockoutLatestExports.utils.arrayGetDistinctValues(types).sort();
